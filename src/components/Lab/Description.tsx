    ...
    <Layout>
      ...
      <div className="my-6">
        ...
        <p className="text-xl">
          ...
          elements by counting the occurrences of each unique value in the input
          array. It works by using an auxiliary array (count array) to store the
          frequency of each element within a specific range. After calculating
          the cumulative count, the algorithm places each element in its correct
          position in the output array. Since it relies on counting rather than
          comparisons, Counting Sort is particularly effective for sorting
          integers or elements within a limited range. However, it is less
          efficient for datasets with a large range of values or non-integer
          data.
        </p>
      </div>
      <div className="my-6">
      ...
      <div className="my-6">
        ...
        <div className="min-h-[200px] h-fit flex flex-col gap-2 w-full items-center justify-center">
          <p className="mb-4">
            ...
            sorting large numbers with a wide range, as it requires extra space
            proportional to 𝑘 k.
          </p>
      ...
      <div className="my-6 ">
        ...
        <ul>
          ...
          <li>
            <strong>Electoral Vote Counting:</strong> Counting and sorting votes
          ...
          <li>
            <strong>Frequency Analysis in NLP:</strong> Counting occurrences of
            words or letters in a document.
          </li>
          <li>
          ...
          <li>
            <strong>Arranging Students by Marks:</strong> Ranking students based
            on objective test scores.
          </li>
        </ul>
      </div>
